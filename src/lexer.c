...
/*
  ...
  Pass throught the buffer to tokenize with
  and ending null (\0) character 

  The buffer_size parameter is inclusive of 
  the null character in the length of the string
*/
