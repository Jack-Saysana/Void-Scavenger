...
#define SHIELD_RECHARGE_RATE_MIN (4.0) //BASE = 5
#define SHIELD_RECHARGE_DELAY_MODIFIER (-0.1)
#define SHIELD_RECHARGE_DELAY_MIN (3.0) //BASE = 2.0
#define SHIELD_POWER_DRAW_MODIFIER (-1.5)
#define SHIELD_POWER_DRAW_MIN (30.0) //BASE = 25
#define WEAPON_NUM_STATS (6)
...
#define WEAPON_PROJ_SPEED_MODIFIER (5.0)
#define WEAPON_PROJ_SPEED_MIN (75.0) //BASE = 100
#define WEAPON_RANGE_MODIFIER (15.0)
#define WEAPON_RANGE_MIN (400) //BASE = 500
#define WEAPON_BULLET_SIZE_MODIFER (0.2)
#define WEAPON_BULLET_SIZE_MIN (0.6) //BASE = 1.0
...
#define SHIELD_RECHARGE_DELAY_CAP (1.0)
#define SHIELD_PWR_DRAW_CAP (5.0)
