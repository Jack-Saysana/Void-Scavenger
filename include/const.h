...
#define REACTOR_STALL_TIME_MIN (9.0) //BASE 7.5
...
#define THRUSTER_MAX_POWER_DRAW_MIN (5.0) //BASE = 3.5
...
#define MAX_TURNING_RAD (190.0)
#define MAX_STOP_DIST (90.0)
